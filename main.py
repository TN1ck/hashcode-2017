...
class Video(object):
    ...
    def popularity_per_endpoint(self, endpoint_id):
        return sum([request.number_of_requests for request in self.requests if request.endpoint_id == endpoint_id])

    def popularity_per_endpoint_norm(self, endpoint_id):
        return sum([request.number_of_requests_norm for request in self.requests if request.endpoint_id == endpoint_id])
